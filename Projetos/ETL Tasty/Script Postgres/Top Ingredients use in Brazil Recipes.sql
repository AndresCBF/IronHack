...
from (
	...
	i.ingredient_name,
	count(i.ingredient_name) as ingredientcountry
	from 
	...
	GROUP BY c.country_tags, i.ingredient_name 
	order by ingredientcountry desc) as t1
where t1.country_tags = 'Brazil' limit 5